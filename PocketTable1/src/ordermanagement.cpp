...
void OrderManagement::on_load() {
  ...
  for (auto order : orders) {
    ...
    ui->table->setItem(index, 1, new QTableWidgetItem(QString::fromStdString(order.email)));
    ...
    ui->table->setItem(index, 2, new QTableWidgetItem(QString::fromStdString(ids_str)));
  }
}
